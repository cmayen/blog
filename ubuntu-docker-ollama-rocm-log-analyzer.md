...
SQL for storing the data generating making metrics, migrating over to k8s, and bringing in capabilities to dig into more log types and group by criticality. Lot's of cool ideas are brewing.
